...
trait ActiveUserHelper
{
    ...
    //缓存相关配置
    protected $cache_key = 'mbbs_active_users';
    ...
    private function calculateActiveUsers()
    {
        ...
        foreach ($users as $user_id => $user) {
            // 找寻下是否可以找到用户；实际上不需要获得user数组中的得分，只需要知道前6是谁就行了
    ...
    private function calculateTopicScore()
    {
        ...
        foreach ($topic_users as $value) {
            $this->users[$value->user_id]['score'] = $value->topic_count * $this->topic_weight;//创建一个二维数组
        }
    }
